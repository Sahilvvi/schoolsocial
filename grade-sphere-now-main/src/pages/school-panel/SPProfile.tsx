...
import { Save, MapPin, School, BookOpen } from "lucide-react";
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="border-border/30">
          ...
          <CardContent className="space-y-4">
            ...
            <div><Label>Banner Image URL</Label><Input value={form.banner} onChange={e => u("banner", e.target.value)} placeholder="https://..." /></div>
            {form.banner && (
        ...
        <Card className="border-border/30">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5 mt-2">
                {form.achievements.split(",").map((a, i) => a.trim() && (
