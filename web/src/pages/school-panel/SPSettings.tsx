    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="bg-white border border-gray-200 rounded-xl divide-y divide-gray-100">
        <div className="p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Control how your school appears on SchoolSocial</p>
            </div>
          </div>
          <div className="space-y-3 pl-12">
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700">Show school on search results</span>
              <input type="checkbox" defaultChecked className="h-4 w-4 text-blue-600 rounded" />
            </label>
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700">Allow parents to send enquiries</span>
              <input type="checkbox" defaultChecked className="h-4 w-4 text-blue-600 rounded" />
            </label>
            <label className="flex items-center justify-between">
        ...
        <div className="p-5">
          ...
          <div className="space-y-3 pl-12">
            <label className="flex items-center justify-between">
              ...
              <input type="checkbox" checked={notifications.email} onChange={(e) => setNotifications(n => ({ ...n, email: e.target.checked }))} className="h-4 w-4 text-blue-600 rounded" />
            </label>
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700">SMS notifications</span>
              <input type="checkbox" checked={notifications.sms} onChange={(e) => setNotifications(n => ({ ...n, sms: e.target.checked }))} className="h-4 w-4 text-blue-600 rounded" />
            </label>
            <label className="flex items-center justify-between">
              <span className="text-sm text-gray-700">Push notifications</span>
              <input type="checkbox" checked={notifications.push} onChange={(e) => setNotifications(n => ({ ...n, push: e.target.checked }))} className="h-4 w-4 text-blue-600 rounded" />
            </label>
          </div>
        </div>
        ...
        <div className="p-5">
          ...
          <div className="space-y-3 pl-12">
            <button className="text-sm text-blue-600 font-semibold hover:text-blue-700">Change Password</button>
            <br />
