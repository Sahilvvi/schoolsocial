...
import {
  School, LogOut, Sun, Moon, Menu, X, ChevronDown, ChevronRight
} from "lucide-react";
  ...
  return (
    <div className="bg-background flex" style={{ height: "100dvh" }}>
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Top header */}
        <header className="h-14 bg-card dark:bg-gray-800 border-b border-border dark:border-gray-700 flex items-center justify-between px-4 shrink-0">
        ...
        {/* Page content */}
        <div className="flex-1 overflow-auto bg-slate-50/50 dark:bg-gray-900/30">
          <motion.div
